...
class AdvancedRAGPipeline:
    ...
    def query(self, question: str, top_k: int = 5, min_score: float = 0.2, stream: bool = False, summarize: bool = False) -> dict[str, Any]:
        ...
        if not results:
            ...
            response = self.model.invoke([prompt.format(context=context, question=question)])
        ...
        if summarize and answer:
            ...
            summary_resp = self.model.invoke([summary_prompt])
...
# Example usage:
adv_rag = AdvancedRAGPipeline(rag_retriever, model)
result = adv_rag.query("what is Ray's phone number and skills", top_k=3, min_score=0.1, stream=True, summarize=True)
