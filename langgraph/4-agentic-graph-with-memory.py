...
response = graph.invoke(State(messages = [HumanMessage(content="Hi my name is John")]),config)
print(response["messages"][-1])

second_response = graph.invoke(State(messages = [HumanMessage(content="What is my name?")]), config)
